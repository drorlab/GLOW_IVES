### Adapted from https://github.com/google-deepmind/alphafold/blob/main/alphafold/relax/cleanup.py
...
def _remove_hydrogens(fixer):
    # OpenMM will sometime complains if we added hydrogens prior and the hydrogen
    # name doesn't follow the required convention
    toDelete = []
    for atom in fixer.topology.atoms():
        if atom.element == app.element.hydrogen:
            toDelete.append(atom)
    print(f'Delete {len(toDelete)} hydrogens')
